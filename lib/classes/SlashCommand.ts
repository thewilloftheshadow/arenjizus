...
export default class SlashCommand {
     ...
     */
    public async validate(interaction: CommandInteraction): Promise<MessageEmbedOptions | null> {
    ...
    public async preCheck(_interaction: CommandInteraction): Promise<[boolean, MessageEmbedOptions?]> {
        return [true]
    }
