...
//                         description: "You have not yet set your persona for the ball! Use `/ballset` to do that, but beware, you can only set it once!",
//                     },
//                     false,
//                     [],
//                     true
...
//                     new MessageButton().setStyle("LINK").setLabel("View Message").setURL(`https://discord.com/channels/${interaction.guild!.id}/${sent.channel_id}/${sent.id}`)
//                 )
//             ]
//         })
//     }
